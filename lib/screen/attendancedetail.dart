...
import 'package:g4s_attendance_applicaton/util/detailinfo.dart';
import 'package:g4s_attendance_applicaton/util/detailitem.dart';
...
Future<void> getAttendanceDetailByDateSearch(
  ...
  try {
    ...
    if (response.statusCode == 200) {
      ...
      print("something is worng ${response.statusCode}");
    }
  } catch (e) {
    Fluttertoast.showToast(msg: "Something went wrong ${e.toString()}");
  }
